...
public class ListaMovimientos {
    ...
    public ListaMovimientos(){
        ...
        movimientos.add(new Movimiento("Amago",30,Tipo.NORMAL,10,ClaseMovimiento.FISICO));
        movimientos.add(new Movimiento("Placaje",40,Tipo.NORMAL,35,ClaseMovimiento.FISICO));
